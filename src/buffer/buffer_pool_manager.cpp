...
auto BufferPoolManager::EvictFrameIfDirty(frame_id_t frame_id, std::shared_ptr<FrameHeader> frame) -> bool {
...
auto BufferPoolManager::LoadPageIntoFrame(std::shared_ptr<FrameHeader> frame, page_id_t page_id) -> bool {
  // 检查是否需要从磁盘读取
  bool need_disk_read;
  {
